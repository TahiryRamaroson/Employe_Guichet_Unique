...
import { CheckCircleIcon, ExclamationCircleIcon } from "@heroicons/react/24/outline";
  ...
  export function ValidationGrossesse() {
    ...
    const importCSV = async (event) => {
      ...
      try {
        const response = await axios.post(`${api_url}/api/Grossesses/import/csv`, formData, {
          headers: {
    ...
    const importExcel = async (event) => {
      ...
      try {
        const response = await axios.post(`${api_url}/api/Grossesses/import/excel`, formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
            'Authorization': 'Bearer ' + sessionStorage.getItem('authToken'),
          },
    ...
    const ValiderById = async (id) => {
      ...
      const apiValiderById = `${api_url}/api/Grossesses/valider/${id}`; 
    ...
    const RefuserById = async (id) => {
      ...
      const apiRefuserById = `${api_url}/api/Grossesses/refuser/${id}`; 
    ...
    const Valider = async () => {
      ...
      try {
        const response = await axios.put(`${api_url}/api/Grossesses/valider`, checkedIds, {
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + sessionStorage.getItem('authToken'),
          },
    ...
    const Refuser = async () => {
      ...
      try {
        const response = await axios.put(`${api_url}/api/Grossesses/refuser`, checkedIds, {
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + sessionStorage.getItem('authToken'),
          },
