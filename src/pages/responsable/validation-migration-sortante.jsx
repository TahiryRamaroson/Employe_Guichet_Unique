...
import { jwtDecode } from "jwt-decode";
  ...
  useEffect(() => {
    ...
    const [checkedItems, setCheckedItems] = useState(
      data_migration_sortante.reduce((acc, item) => {
        acc[item.id] = false;
        return acc;
      }, {})
    );
    ...
    const handleSelectAllChange = () => {
      ...
      const newCheckedItems = data_migration_sortante.reduce((acc, item) => {
    ...
    <Card className="h-full w-full">
        ...
        <Card color="transparent" shadow={false} className="p-6">
          <form className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div className="flex flex-col gap-4"></div><div className="flex flex-col gap-4"></div><div className="flex flex-col gap-4"></div><div className="flex flex-col gap-4"></div>
            <div className="flex flex-col gap-4">
