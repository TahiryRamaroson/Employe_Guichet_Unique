...
import {CheckIcon, ArrowUpTrayIcon, DocumentIcon, XMarkIcon} from "@heroicons/react/24/solid";
...
import { jwtDecode } from "jwt-decode";
  ...
  export function ValidationNaissance() {
    ...
    const [checkedItems, setCheckedItems] = useState(
      data_naissance.reduce((acc, item) => {
        acc[item.id] = false;
        return acc;
      }, {})
    );
    ...
    const handleSelectAllChange = () => {
      ...
      const newCheckedItems = data_naissance.reduce((acc, item) => {
