...
var data_historique_action = [
    {
        Plainte: {
            ...
            statut: "validé",
            statut_traitement: "Non traité"
        },
        date_visite: "10/10/2024",
        actions:[
            {
                id: 0,
                description: "Appui psychologique"
            },
            {
                id: 1,
                description: "Appui financière"
            },
        ],
        responsable: {
            id: 1,
  ...
  export default data_historique_action;